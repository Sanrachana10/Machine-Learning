...
# Inject everything in ONE shot — styles + full HTML
st.markdown("""
...
<div style="min-height:100vh; background: radial-gradient(ellipse at 20% 0%, rgba(201,168,76,0.08) 0%, transparent 55%), radial-gradient(ellipse at 80% 100%, rgba(201,168,76,0.05) 0%, transparent 50%), linear-gradient(160deg,#0b1f3a 0%,#091729 60%,#0d2040 100%); padding-bottom:80px; font-family:'DM Sans',sans-serif;">
  ...
  <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:22px; max-width:1100px; margin:0 auto; padding:0 40px;">
    ...
    <a href="https://your-app-1.streamlit.app" target="_blank" style="text-decoration:none; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); border-radius:14px; padding:32px 28px 28px; display:block; transition:transform 0.28s,box-shadow 0.28s; position:relative; overflow:hidden;"
    ...
    <a href="https://your-app-2.streamlit.app" target="_blank" style="text-decoration:none; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); border-radius:14px; padding:32px 28px 28px; display:block; transition:transform 0.28s,box-shadow 0.28s;"
       onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 20px 60px rgba(0,0,0,0.4)';this.style.borderColor='rgba(201,168,76,0.35)';"
       onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(255,255,255,0.09)';">
    ...
    <a href="https://your-app-3.streamlit.app" target="_blank" style="text-decoration:none; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); border-radius:14px; padding:32px 28px 28px; display:block; transition:transform 0.28s,box-shadow 0.28s;"
       onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 20px 60px rgba(0,0,0,0.4)';this.style.borderColor='rgba(201,168,76,0.35)';"
       onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(255,255,255,0.09)';">
    ...
    <a href="https://your-app-4.streamlit.app" target="_blank" style="text-decoration:none; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); border-radius:14px; padding:32px 28px 28px; display:block; transition:transform 0.28s,box-shadow 0.28s; grid-column:1;"
       onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 20px 60px rgba(0,0,0,0.4)';this.style.borderColor='rgba(201,168,76,0.35)';"
       onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(255,255,255,0.09)';">
    ...
    <a href="https://your-app-5.streamlit.app" target="_blank" style="text-decoration:none; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.09); border-radius:14px; padding:32px 28px 28px; display:block; transition:transform 0.28s,box-shadow 0.28s; grid-column:2;"
       onmouseover="this.style.transform='translateY(-6px)';this.style.boxShadow='0 20px 60px rgba(0,0,0,0.4)';this.style.borderColor='rgba(201,168,76,0.35)';"
       onmouseout="this.style.transform='';this.style.boxShadow='';this.style.borderColor='rgba(255,255,255,0.09)';">
